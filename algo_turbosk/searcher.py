# coding=utf-8
from sk_searcher import Searcher as SkSearcher
from turbo_searcher import Searcher as TurboSearcher
...
class Searcher(AbstractSearcher):
    ...
    def __init__(self, parameters_config, n_iter, n_suggestion):
        ...
        self.turbo = TurboSearcher(parameters_config, n_iter, n_suggestion)
        self.sk = SkSearcher(parameters_config, n_iter, n_suggestion)
    ...
    def suggest(self, suggestion_history, n_suggestions=1):
        ...
        turbo_suggest = self.turbo.suggest(suggestion_history, n_suggestions)
        sk_suggest = self.sk.suggest(suggestion_history, n_suggestions)

        return turbo_suggest[:n] + sk_suggest[n:]
